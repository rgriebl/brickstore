...
# that says what actually went wrong. Included by the generator scripts, which
# run standalone under `cmake -P`.
#
...
function(imagescale_run label)
    ...
    if (NOT stderr)
        ...
        set(hint
            "\nThe imagescale tool did not produce any output, so it most likely never ran. It "
