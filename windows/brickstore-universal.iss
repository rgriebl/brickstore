...
; generated by windows/generate-icons.cmake, not committed. Same path relative to
; SOURCE_DIR as the per-architecture installer uses: this job has no build tree, so
; the Windows-Installer-Assets artifact is downloaded to generated/icons to match.
WizardSmallImageFile={#SOURCE_DIR}\..\generated\icons\windows-installer.png
