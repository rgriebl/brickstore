...
function listHeader ( page, ps )
{
    ...
    page. drawText ( ps. x + xs( ps. w, 130 ), y, xs( ps. w, 20 ), h, CReportPage.AlignCenter, "Price" );
    page. drawText ( ps. x + xs( ps. w, 150 ), y, xs( ps. w, 20 ), h, CReportPage.AlignCenter, "Total" );
...
function listItem ( page, ps, item, odd )
{
    ...
    page. drawText ( ps. x + xs( ps. w, 130 ), y, xs( ps. w, 18 ), h, CReportPage.AlignRight   | CReportPage.AlignVCenter, Money. toLocalString ( item. price, true ));
    page. drawText ( ps. x + xs( ps. w, 149 ), y, xs( ps. w, 20 ), h, CReportPage.AlignRight   | CReportPage.AlignVCenter, Money. toLocalString ( item. total, true ));
