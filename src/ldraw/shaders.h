...
// copied from Qt's HelloGL2 example, distributed under 3-clause BSD license:
...
static const char *vertexShaderSourceSimple =
        ...
        "uniform mat4 projMatrix;\n"
        "uniform mat4 mvMatrix;\n"
        "attribute vec4 vertex;              // Der zu transformierende Vertex\n"
        "attribute vec4 color;               // Ein Per-Vertex Attribut\n"
