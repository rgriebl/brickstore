    ...
    : QWidget(parent, Qt::Window)
{
    ...
    w_toggle_picture->setIcon(QIcon(":/images/bricklink_info.png"));

    w_price_guide->setFrameStyle(QFrame::StyledPanel | QFrame::Sunken);
    w_price_guide->setLineWidth(2);

    w_toggle_price_guide->setIcon(QIcon(":/images/bricklink_priceguide.png"));

    w_appears_in->setFrameStyle(QFrame::StyledPanel | QFrame::Sunken);
    w_appears_in->setLineWidth(2);

    w_toggle_appears_in->setIcon(QIcon(":/images/appearsin.png"));
